...
# Pacman Mirror Configuration (pacman-mirror)
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/zyrakq/arch-devcontainer-features/blob/main/src/pacman-mirror/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
