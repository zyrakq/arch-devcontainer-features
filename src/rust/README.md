...
Installs Rust, Cargo, and development tools from pre-compiled packages for fast installation on Arch Linux
...
|-----|-----|-----|-----|
| installRustSrc | Install Rust source code (for IDE support and rust-analyzer) | boolean | true |
| installRustAnalyzer | Install rust-analyzer LSP server (for IDE integration) | boolean | true |
